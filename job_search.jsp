    ...
    <body id="top">
        ...
        <div class="wrapper row1">
            <header id="header" class="hoc clear">
                ...
                <nav id="mainav" class="fl_right"> 
                    <!-- ################################################################################################ -->
                    <ul class="clear">
          <li class="active"><a href="JobSeekers_Home.jsp">Home</a></li>
                        <li><a href="Searchjob.jsp">Search Jobs</a></li>
                        <li><a href="Upload_resume.jsp">Upload Resume</a></li>
        ...
        <div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/01.png');">
            <div id="breadcrumb" class="hoc clear"> 
                <!-- ################################################################################################ -->
                <h6 class="heading">Job Details</h6>
                <ul>
                </ul>
                <!-- ################################################################################################ -->
            </div>
                            ...
                            <div class="g-position--relative g-bg-color--primary">
                                <div class="g-container--md g-padding-y-125--xs">
                                    <div class="g-text-center--xs g-margin-t-50--xs g-margin-b-80--xs">
                                        <h2 class="g-font-size-32--xs g-font-size-36--sm g-color--white">Job Details</h2>
                                    </div>
                                    <div class="scrollable">
                                        <table>
                                            ...
                                            <%   
                                                ...
                                                try {
                                                    ResultSet rs = st.executeQuery("SELECT * FROM job_portal where j_city='"+city+"'");
                                                    while (rs.next()) {
                                            %>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td ><%=rs.getString("vaccancy")%></td>
                                                    <td ><%=rs.getString("Description")%></td>
                                                    <td ><%=rs.getString("Contact")%></td>
                                                    <td ><%=rs.getString("Offmail")%></td>
                                                    <td ><%=rs.getString("j_address")%></td>
                                                    <td ><%=rs.getString("j_city")%></td>
                                                    <td ><%=rs.getString("j_state")%></td>
                                                    <td ><%=rs.getString("post_time")%></td>
                                                </tr>
                                            </tbody>
                                            <%                                        }
                                                } catch (Exception ex) {
