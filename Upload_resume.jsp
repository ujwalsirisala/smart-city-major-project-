...
<div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/01.png');">
  <div id="breadcrumb" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h6 class="heading">Job Seeker</h6>
    <ul>
      <!--<li><a href="#">Business and Job Portal</a></li>-->
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <center><div id="comments">
        ...
        <select onchange="print_city('state', this.selectedIndex);" id="sts" name ="state" class="form-control" required style="width: 200px"></select>
       <br>
       <br>
       <select id ="state" class="form-control" name="city" required style="width: 200px" ></select>
       <br>
       <input type="file" required="" style="width: 200px" class="form-control" name="resume">   
