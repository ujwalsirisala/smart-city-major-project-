    ...
    <body id="top">
        ...
        <div class="wrapper row1">
            <header id="header" class="hoc clear">
                ...
                <nav id="mainav" class="fl_right"> 
                    <!-- ################################################################################################ -->
                    <ul class="clear">
                        <li class="active"><a href="Tourist_Home.jsp">Home</a></li>
                        <li><a href="tourist_view.jsp">View Info</a></li>
        ...
        <div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/01.png');">
            <div id="breadcrumb" class="hoc clear"> 
                <!-- ################################################################################################ -->
                <h6 class="heading">Place Details</h6>
                <ul>
                </ul>
                <!-- ################################################################################################ -->
            </div>
                                    ...
                                    <div class="scrollable">
                                        <table>
                                            ...
                                            <%                                                Connection con = SQLconnection.getconnection();
                                                ...
                                                try {
                                                    ResultSet rs = st.executeQuery("SELECT * FROM places where p_city='" + city + "' and cat='" + cat + "'");
                                                    while (rs.next()) {
                                            %>
                                            <tbody>
                                                <tr> <th>Id</th>
                                                ...
                                                <tr> 
                                                    ...
                                                    <tr>
                                                    <th>Images</th>
                                                    <td ><img class="img-responsive" src="pic2.jsp?uid=<%=rs.getString("id")%>" alt="Image"></td>
                                                    <td ><img class="img-responsive" src="pic3.jsp?uid=<%=rs.getString("id")%>" alt="Image"></td>
                                                    <td ><img class="img-responsive" src="pic4.jsp?uid=<%=rs.getString("id")%>" alt="Image"></td>
                                                    </tr>
