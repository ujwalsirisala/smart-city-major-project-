    ...
    <body id="top">
        ...
        <div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/01.png');">
            <div id="breadcrumb" class="hoc clear"> 
                <!-- ################################################################################################ -->
                <h6 class="heading">Student Details</h6>
                <ul>
                </ul>
                <!-- ################################################################################################ -->
            </div>
        ...
        <div class="g-position--relative g-bg-color--primary">
            <div class="g-container--md g-padding-y-125--xs">
                <div class="g-text-center--xs g-margin-t-50--xs g-margin-b-80--xs">
                    <h2 class="g-font-size-32--xs g-font-size-36--sm g-color--white">Students Portal Information</h2>
                </div>
                <form class="center-block g-width-200--sm g-width-550--md" action="student_details" method="post" enctype="multipart/form-data">
                    ...
                    <div class="g-margin-b-30--xs">
                        <input type="text" class="form-control s-form-v3__input" name="s_name" required="" placeholder="*Place Name">
                    </div>
                    ...
                    <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                            ...
                            <input type="text" class="form-control s-form-v3__input" name="s_city" value="<%=city%>" required="" readonly="">
                        </div>
                        <div class="col-sm-6">
                             <label style=" margin-right: 900px; background-color: activecaption">State</label>
                            <input type="text" class="form-control s-form-v3__input" name="s_state" value="<%=state%>" required="" readonly="">
                        </div>
                    </div>
                    <div class="g-margin-b-30--xs">
                        <input type="text" class="form-control s-form-v3__input" name="s_address" required="" placeholder="* Full Address">
                    </div>
