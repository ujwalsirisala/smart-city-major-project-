...
<div class="wrapper row1">
  <header id="header" class="hoc clear">
    <div id="logo" class="fl_left"> 
      <!-- ################################################################################################ -->
      <h1><a href="index.jsp">City Guide</a></h1>
      <!-- ################################################################################################ -->
    </div>
      ...
      <center><div id="comments">
        ...
        <form action="reg_code.jsp" method="get">
          ...
          <div class="block clear">
            ...
            <input type="email" name="email" id="name" value="" size="22" required style="width: 200px">
          </div>
          <div class="block clear">
            <label for="name">Phone No <span>*</span></label>
            <input type="text" name="phone" id="name" value="" size="22" required style="width: 200px">
          </div>
          <div class="block clear">
            <label for="name">Role <span>*</span></label>
            <select  name="role" id="name"  required style="width: 200px">
